...
CHANGELOG <- data.frame("Revision" = c('June, 2022 (Current)', 'June, 2019', 'February, 2019'))
CHANGELOG$GitHub_Tag <- c('Release V2022.0', 'Release V2019.1', 'Release V2019.0')
CHANGELOG$PDF <- c('V2022.0 PDF', 'V2019.1 PDF', 'V2019.0 PDF')
CHANGELOG$Summary <- c('Many changes from Stuart Beaton, Mike Reeves, and Adriana Raudzens Bailey. Correction to Eq. 7.9 to have UPRESS multiplied by 10. Other cosmetic changes have been made to the PDF-format version of February 2019, which was generated using the program LyX', 'License has been changed from GPL to BSD-3.', 'Original release.')
```
## Document Change Log
```{r include = TRUE}
