...
(\#eq:alphau)
\end{equation}  
See the following manuscript, <a href="www/TatChangesAndRecovFactor_report20220603.pdf">NCAR GV Aircraft TAT Sensor Update: Signal Path Changes and Recovery Factor Modeling</a> prepared by Josh Carnes. <br />
Some studies of the recovery factor are discussed further in <a href="www/RecoveryFactorStudy.pdf">this memo</a>.<br />
<br />
...
#### Ophir Air Temperature (<span class="math inline"><sup>∘</sup></span>C): OAT {-#OAT} *(obsolete)*
...
#### Dew/Frost Point (<span class="math inline">º</span>C): DPx, DP_x, DP_DPx, MIRRTMP_DPx See below for DP_VXL. {-#dew-point}
...
#### Water Vapor Pressure (hPa): EWx, EWX, EW_VXL, EW_UVH, EW_VXL, EDPC (obsolete) {-#ewx}
