...
## Units and Abbreviations {#units-and-abbreviations}
...
5. The unit “hertz” (abbreviation Hz) is the proper unit for a periodic sampling frequency and will be used here in place of the more awkward “samples per second.”
...
In Appendix A there is a list of symbols.^[Some symbols used only once and defined where they are used are omitted from this list] The next table defines some abbreviations and additional symbols used for units in this report, in addition to the standard abbreviations for the mks system of units:
<!-- It would be useful to translate the following table from html to Rmd: -->
...
```{r include = TRUE}
knitr::kable(SymbolTable, align=c('cc')) %>% kable_styling(bootstrap_options = 'bordered') %>%
  add_footnote("where ≡ is used, the relation is exact by definition", notation="alphabet") %>%
  scroll_box(width='90%')
```
...
<p>Example attribute:  <br />
<code>Time:units = “seconds since 2006-04-26 12:55:00 +0000” </code>;</p>
<p>For code examples that show how to use “Time” see:<br />
<a href="http://www.eol.ucar.edu/raf/Software/TimeExamp.html">http://www.eol.ucar.edu/raf/Software/TimeExamp.html</a></p>
...
#### Raw Tape Time (h, min, s): HOUR, MINUTE, SECOND (*Obsolete*) {-#hms}
...
#### Date (m, d, y): MONTH, DAY, YEAR (*Obsolete*) {-#mdy}
...
## Synchronization of Measurements {#synchronization-of-measurements}
