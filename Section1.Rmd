...
3. In flight, the data are processed by the *“nimbus”* data processing program, which makes them available for display via ["aeros"](https://www.eol.ucar.edu/software/aeros) for real-time monitoring of measurements.  
